...
struct BubbleSortVisualizationView: View {
            ...
            ScrollView {
                VStack(spacing: Theme.Spacing.large) {
                    ...
                    VStack(spacing: Theme.Spacing.small) {
                        ...
                        Text("Compare adjacent elements and swap if needed")
                    ...
                    if viewModel.isAnimating || viewModel.isCompleted {
                        BubbleSortStepInformationPanel(
...
// MARK: - Bubble Sort Step Information Panel
struct BubbleSortStepInformationPanel: View {
    let currentPass: Int
    let totalPasses: Int
    let currentStep: Int
            ...
            VStack(spacing: Theme.Spacing.small) {
                ...
                if !isCompleted {
                    ...
                    if !comparisonResult.isEmpty {
                        ...
                        HStack {
                            Image(systemName: comparisonResult.contains("⚡") ? "bolt.circle.fill" : "checkmark.circle.fill")
                                .foregroundColor(comparisonResult.contains("⚡") ? .orange : .green)
...
// MARK: - Bubble Sort Array Element View
struct BubbleSortArrayElementView: View {
    let value: Int
    let index: Int
    let state: BubbleSortViewModel.ElementState
    ...
    var body: some View {
        VStack(spacing: Theme.Spacing.small) {
            ...
            RoundedRectangle(cornerRadius: 8)
                ...
                .scaleEffect(state == .comparing ? 1.05 : 1.0)
