...
struct InsertionSortVisualizationView: View {
            ...
            ScrollView {
                VStack(spacing: Theme.Spacing.large) {
                    ...
                    VStack(spacing: Theme.Spacing.small) {
                        ...
                        Text("Insert each element into its correct position")
                    ...
                    if !viewModel.isAnimating {
                        VStack(spacing: Theme.Spacing.medium) {
                            ...
                            VStack(alignment: .leading, spacing: Theme.Spacing.small) {
                                ...
                                TextField("e.g., 12,11,13,5,6", text: $viewModel.arrayInput)
                    ...
                    if viewModel.isAnimating || viewModel.isCompleted {
                        InsertionSortStepInformationPanel(
...
// MARK: - Insertion Sort Step Information Panel
struct InsertionSortStepInformationPanel: View {
    let currentPass: Int
    let totalPasses: Int
    let currentStep: Int
                    ...
                    if !comparisonResult.isEmpty {
                        ...
                        HStack {
                            Image(systemName: comparisonResult.contains("⚡") ? "bolt.circle.fill" : 
                                           comparisonResult.contains("🔑") ? "key.fill" : "checkmark.circle.fill")
                                .foregroundColor(comparisonResult.contains("⚡") ? .orange : 
                                               comparisonResult.contains("🔑") ? .red : .green)
...
// MARK: - Insertion Sort Array Element View
struct InsertionSortArrayElementView: View {
    let value: Int
    let index: Int
    let state: InsertionSortViewModel.ElementState
    ...
    var body: some View {
        VStack(spacing: Theme.Spacing.small) {
            ...
            RoundedRectangle(cornerRadius: 8)
                ...
                .scaleEffect(state == .key || state == .comparing ? 1.05 : 1.0)
