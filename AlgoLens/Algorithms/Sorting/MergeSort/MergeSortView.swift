...
struct MergeSortVisualizationView: View {
    @StateObject private var viewModel = MergeSortViewModel()
    ...
    var body: some View {
            ...
            ScrollView {
                VStack(spacing: Theme.Spacing.large) {
                    ...
                    VStack(spacing: Theme.Spacing.small) {
                        ...
                        Text("Divide and conquer - split, sort, and merge")
                    ...
                    if !viewModel.isAnimating {
                        VStack(spacing: Theme.Spacing.medium) {
                            ...
                            VStack(alignment: .leading, spacing: Theme.Spacing.small) {
                                ...
                                TextField("e.g., 38,27,43,3,9,82,10", text: $viewModel.arrayInput)
        ...
        .navigationDestination(isPresented: $showQuiz) {
            QuizView(algorithm: Algorithm(
                ...
                complexity: Algorithm.Complexity(time: "O(n log n)", space: "O(n)"),
...
// MARK: - Merge Sort Step Information Panel
struct MergeSortStepInformationPanel: View {
    let currentPass: Int
    let currentStep: Int
                    ...
                    if !comparisonResult.isEmpty {
                        ...
                        HStack {
                            Image(systemName: comparisonResult.contains("⚡") ? "bolt.circle.fill" : 
                                           comparisonResult.contains("🔀") ? "arrow.triangle.branch" :
                                           comparisonResult.contains("🔗") ? "link.circle.fill" : "checkmark.circle.fill")
...
// MARK: - Merge Sort Array Element View
struct MergeSortArrayElementView: View {
    let value: Int
    let index: Int
    let state: MergeSortViewModel.ElementState
