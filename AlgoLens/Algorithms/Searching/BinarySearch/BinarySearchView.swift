//
//  BinarySearchVisualizationView.swift
//  AlgoLens
//
...
struct BinarySearchVisualizationView: View {
            ...
            ScrollView {
                VStack(spacing: Theme.Spacing.large) {
                    ...
                    VStack(spacing: Theme.Spacing.small) {
                        ...
                        Text("Divide search space in half each step")
                    ...
                    if !viewModel.isSearching {
                        VStack(spacing: Theme.Spacing.medium) {
                            ...
                            HStack(spacing: Theme.Spacing.small) {
                                ...
                                Text("Array is automatically sorted for Binary Search")
                                    .font(.system(size: 13, weight: .medium))
                                    .foregroundColor(Theme.Colors.secondaryText)
                            }
                    ...
                    if viewModel.isSearching || viewModel.isCompleted {
                        BinarySearchStepInformationPanel(
...
// MARK: - Binary Search Step Information Panel
struct BinarySearchStepInformationPanel: View {
    let lowPointer: Int
    let midPointer: Int
    let highPointer: Int
    let lowValue: Int?
        ...
        VStack(spacing: Theme.Spacing.medium) {
            ...
            VStack(spacing: Theme.Spacing.small) {
                ...
                if !isCompleted {
                    ...
                    if let value = midValue {
                        Divider()
                            .padding(.vertical, 4)
                        InfoRow(label: "Mid Value", value: "\(value)", icon: "number.circle.fill", color: .orange)
                    }
...
// MARK: - Binary Search Array Element View
struct BinarySearchArrayElementView: View {
    let value: Int
    let index: Int
    let state: BinarySearchViewModel.ElementState
