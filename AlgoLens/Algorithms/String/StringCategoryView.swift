            ...
            ScrollView {
                VStack(spacing: Theme.Spacing.large) {
                    ...
                    VStack(spacing: Theme.Spacing.small) {
                        ...
                        Text("Master pattern matching and string manipulation")
                    ...
                    VStack(spacing: Theme.Spacing.medium) {
                        ForEach(viewModel.algorithms) { algorithm in
                            NavigationLink(value: algorithm) {
                                StringAlgorithmCard(algorithm: algorithm)
                            }
...
// MARK: - String Algorithm Card
struct StringAlgorithmCard: View {
            ...
            VStack(alignment: .leading, spacing: Theme.Spacing.small / 2) {
                ...
                if let complexity = algorithm.complexity {
                    HStack(spacing: Theme.Spacing.small) {
                        StringComplexityBadge(label: "Time", value: complexity.time)
                        StringComplexityBadge(label: "Space", value: complexity.space)
                    }
                    .padding(.top, 2)
                }
            }
...
// MARK: - String Complexity Badge
struct StringComplexityBadge: View {
    let label: String
    let value: String
